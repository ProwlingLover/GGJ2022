...
namespace Pathfinding {
	...
	public class BaseAIEditor : EditorBase {
		...
		protected override void Inspector () {
			...
			Rigidbody rigid = mono.GetComponent<Rigidbody>();
			Rigidbody2D rigid2D = mono.GetComponent<Rigidbody2D>();
			CharacterController controller = mono.GetComponent<CharacterController>();
			// unity 2019.2以后才支持TryGetComponent
